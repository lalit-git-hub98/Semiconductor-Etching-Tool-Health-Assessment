...
for k=1:length(Baseline1Run)
    s4Data = Baseline1Run{k}.Data(Baseline1Run{k}.Data(:, 2)==4, :);
    s5Data = Baseline1Run{k}.Data(Baseline1Run{k}.Data(:, 2)==5, :);
...
for k=1:length(TestCase1Run)
    s4Data_T = TestCase1Run{k}.Data(TestCase1Run{k}.Data(:, 2)==4, :);
    s5Data_T = TestCase1Run{k}.Data(TestCase1Run{k}.Data(:, 2)==5, :);
...
xlabel('Etcher run');
ylabel('SPE Value');
title('SPE Health Assessment Plot Etcher 1');
hold off
...
xlabel('Etcher run');
ylabel('T^2 Value');
title('T^2 Health Assessment Plot Etcher 1');
hold off
...
xlabel('Etcher run');
ylabel('MQE Value');
title('MQE Health Assessment Plot Etcher 1');
...
if isfile('Etcher1Health.xlsx')
    delete Etcher1Health.xlsx;
end
writetable(testingResults, 'Etcher1Health.xlsx');
